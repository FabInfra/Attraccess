...
import { AddGroupIntroducer } from './components/AddGroupIntroducer';
import * as en from './translations/en';
import * as de from './translations/de';
import { TFunction } from 'i18next';
import { GroupIntroducersList } from './components/GroupIntroducersList';
import { memo } from 'react';
import { useResourceGroupIntroducersServiceGetAllResourceGroupIntroducers } from '@attraccess/react-query-client';
// eslint-disable-next-line @nx/enforce-module-boundaries
  ...
  return (
    <Card>
      ...
      <CardBody className="space-y-4">
        <AddGroupIntroducer groupId={groupId} />
