...
export const useAuthenticationServiceGetRegistrationOptionsSuspense = <TData = Common.AuthenticationServiceGetRegistrationOptionsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseAuthenticationServiceGetRegistrationOptionsKeyFn(queryKey), queryFn: () => AuthenticationService.getRegistrationOptions() as TData, ...options });
export const useAuthenticationServiceGetAuthenticationOptionsSuspense = <TData = Common.AuthenticationServiceGetAuthenticationOptionsDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>(queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useSuspenseQuery<TData, TError>({ queryKey: Common.UseAuthenticationServiceGetAuthenticationOptionsKeyFn(queryKey), queryFn: () => AuthenticationService.getAuthenticationOptions() as TData, ...options });
